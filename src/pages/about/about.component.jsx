            ...
            <div className="container">
                <div className="row gy-lg-0 gy-4 ">
                    <div className="col-lg-7">
                        <div className="statistics-widget-2 wow fadeInUp">
                            <div className="row gx-0">
                                ...
                                <div className="col-5">
                                    <img className="img-fluid" src="img/statistics/img-1.png" alt="img" />
                                </div>
                    ...
                    <div className="col-lg-5">
                        <div className="statistics-widget-2  wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div className="row pt-30 pb-30 gy-4 gy-lg-0">
                    <div className="col-lg-7">
                        <div className="row gy-4 gy-lg-0">
                            <div className="col-lg-4 col-md-6">
                                <div className="statistics-widget-2 wow fadeInRight" data-wow-delay="0.1s">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="statistics-widget-2 wow fadeInRight" data-wow-delay="0.3s">
                            ...
                            <div className="col-lg-4 ">
                                <div className="statistics-widget-2 wow fadeInRight" data-wow-delay="0.5s">
                    ...
                    <div className="col-lg-5 ">
                        <div className="statistics-widget-2 wow fadeInRight" data-wow-delay="0.7s">
                            <div className="widget-content widget-6"
                ...
                <div className="row gy-4 gy-md-0">
                    <div className="col-md-5">
                        <div className="statistics-widget-2 wow fadeInLeft" data-wow-delay="0.1s">
                            <div className="widget-content widget-7"
                    ...
                    <div className="col-md-7">
                        <div className="statistics-widget-2 wow fadeInLeft" data-wow-delay="0.3s">
                            <div className="row gx-0">
                                <div className="col-5">
                                    <img className="img-fluid" src="img/statistics/img-6.png" alt="img" />
        ...
        <section className="recognition-area bg_white pt-135 pb-140">
            <div className="container">
                <div className="section-title text-start">
                    ...
                    <h2 className="mb-0 wow fadeInUp" data-wow-delay="0.2s">Milestones and Accolades</h2>
                </div>

                <div className="recognition-widget pt-70">
                    <div className="row gy-4 gy-lg-0">
                        <div className="col-lg-3 col-5">
                            <div className="widget-navigation wow fadeInUp pe-lg-4" data-wow-delay="0.1s">
                                <ul className="nav nav-tabs" id="myTab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link active" id="2020-tab" data-bs-toggle="tab" href="#twenty"
                                            role="tab" aria-controls="twenty" aria-selected="true">2020</a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link" id="2019-tab" data-bs-toggle="tab" href="#nineteen"
                                            role="tab" aria-controls="nineteen" aria-selected="false">2019</a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link" id="2018-tab" data-bs-toggle="tab" href="#eighteen"
                                            role="tab" aria-controls="eighteen" aria-selected="false">2018</a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link" id="2017-tab" data-bs-toggle="tab" href="#seventeen"
                                            role="tab" aria-controls="seventeen" aria-selected="false">2017</a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link " id="2016-tab" data-bs-toggle="tab" href="#sixteen"
                                            role="tab" aria-controls="sixteen" aria-selected="false">2016</a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link " id="2015-tab" data-bs-toggle="tab" href="#fifteen"
                                            role="tab" aria-controls="fifteen" aria-selected="false">2015</a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="nav-link " id="2014-tab" data-bs-toggle="tab" href="#lessfifteen"
                        ...
                        <div className="col-lg-4 col-7">
                            <div className="tab-content wow fadeInUp" data-wow-delay="0.3s" id="myTabContent">
                                <div className="tab-pane fade show active" id="twenty" role="tabpanel"
                                ...
                                <div className="tab-pane fade" id="nineteen" role="tabpanel" aria-labelledby="2019-tab">
                                    <h3>2019</h3>
                                    <p>The First Mauritian Bank to join the GRI Community</p>
                                    <p>Instant account opening with a Customer On-boarding App</p>
                                </div>
                                <div className="tab-pane fade" id="eighteen" role="tabpanel" aria-labelledby="2018-tab">
                                    <h3>2018</h3>
                                    <p>The First Mauritian Bank to join the GRI Community</p>
                                    <p>Instant account opening with a Customer On-boarding App</p>
                                </div>
                                <div className="tab-pane fade" id="seventeen" role="tabpanel" aria-labelledby="2017-tab">
                                    <h3>2017</h3>
                                    <p>The First Mauritian Bank to join the GRI Community</p>
                                    <p>Instant account opening with a Customer On-boarding App</p>
                                </div>
                                <div className="tab-pane fade" id="sixteen" role="tabpanel" aria-labelledby="2016-tab">
                                    <h3>2016</h3>
                                    <p>The First Mauritian Bank to join the GRI Community</p>
                                    <p>Instant account opening with a Customer On-boarding App</p>
                                </div>
                                <div className="tab-pane fade" id="fifteen" role="tabpanel" aria-labelledby="2015-tab">
                                    <h3>2015</h3>
                                    <p>The First Mauritian Bank to join the GRI Community</p>
                                    <p>Instant account opening with a Customer On-boarding App</p>
                                </div>
                                <div className="tab-pane fade" id="lessfifteen" role="tabpanel" aria-labelledby="2014-tab">
                        ...
                        <div className="col-xl-4 col-lg-5 offset-xl-1 pr-lg-35 pl-lg-35">
                            <div className="accolades-widget wow fadeInUp" data-wow-delay="0.5s">
                                ...
                                <div className="accolades-content">
                                    <ul>
                                        <li className="">
                                            ...
                                            <p className="text">Straight-Through processing (STP) Excellence Award</p>
                                        </li>
                                        <li className="mt-3">
                                            <p className="subtitle">MARCOM AWARDS</p>
                                            <p className="text">Platinum Winner for ‘The Believers’ Campaign</p>
                                        </li>
                                        <li className="mt-3">
            ...
            <div className="container">
                <div className="row align-items-end">
                    ...
                    <div className="col-sm-4 text-end">
                        <a href="#" className="theme-btn theme-btn-outlined wow fadeInLeft"> see more <i
                                className="arrow_carrot-right "></i></a>
                ...
                <div className="row pt-65 gy-md-0 gy-4">
                    <div className="col-lg-4">
                        <div className="single-leadership-widget wow fadeInUp " data-wow-delay="0.1s">
                            <a href="#">
                    ...
                    <div className="col-lg-4">
                        <div className="single-leadership-widget wow fadeInUp " data-wow-delay="0.3s">
                            <a href="#">
                    ...
                    <div className="col-lg-4">
                        <div className="single-leadership-widget wow fadeInUp " data-wow-delay="0.5s">
                            <a href="#">
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-md-6 ">
                        <div className="cta-content mt-3 mt-sm-0 text-sm-end text-center">
                            <a href="#" className="theme-btn wow fadeInLeft">See results</a>
                        </div>
                    </div>
                </div>
            </div>
